...
namespace ET
{
	...
	public sealed class TChannel: AChannel
	{
		...
		public override void Dispose()
		{
			...
			Log.GetLogger().Information($"channel dispose: {this.Id} {this.RemoteAddress} {this.Error}");
		...
		public void Send(long actorId, MemoryStream stream)
		{
			...
			//MemoryStreamPool.Instance.Recycle(stream);
		...
		public void StartRecv()
		{
			while (true)
			{
				...
				{
					Log.GetLogger().Error($"tchannel error: {this.Id}\n{e}");
		...
		private void HandleRecv(SocketAsyncEventArgs e)
		{
			...
			while (true)
			{
				...
				{
					Log.GetLogger().Error($"ip: {this.RemoteAddress} {ee}");
		...
		private void OnRead(MemoryStream memoryStream)
		{
			...
			{
				Log.GetLogger().Error($"{this.RemoteAddress} {memoryStream.Length} {e}");
		...
		{
			Log.GetLogger().Information($"TChannel OnError: {error} {this.RemoteAddress}");

...
namespace ET
{
public partial class UnitConfigCategory : CategoryBase
{
    public static UnitConfigCategory Instance;
    
    private System.Collections.Generic.Dictionary<int, UnitConfig> _dataMap;
    private System.Collections.Generic.List<UnitConfig> _dataList;
